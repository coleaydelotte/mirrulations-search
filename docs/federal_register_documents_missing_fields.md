...
From the Federal Register document JSON (example: `data/runs/CMS_2026/federal_register/2025-21121.json`), the following fields are **not represented** in the pasted Mirrulations `federal_register_documents` schema.
